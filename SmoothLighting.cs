...
namespace FancyLighting
{
    class SmoothLighting
    {
		...
		internal void DrawSmoothLightingTiles()
		{
			if (!FancyLightingMod.SmoothLightingEnabled) return;
			...
			Main.instance.GraphicsDevice.SetRenderTarget(Main.instance.tileTarget);
			Main.instance.GraphicsDevice.Clear(Color.Transparent);
			Main.spriteBatch.Begin();
			Main.spriteBatch.Draw(
				surface,
		...
		internal void DrawSmoothLightingWalls()
		{
			if (!FancyLightingMod.SmoothLightingEnabled) return;
			...
			Main.spriteBatch.Draw(
				colors,
				colorsPosition + (Main.instance.wallTarget.Size() - Main.screenTarget.Size()) / 2f,
				null,
				Color.White,
				0f,
				Vector2.Zero,
		...
		internal void DrawSmoothLightingTiles2()
		{
			if (!FancyLightingMod.SmoothLightingEnabled) return;
			...
			Main.spriteBatch.Draw(
				colors,
				colorsPosition + (Main.instance.tile2Target.Size() - Main.screenTarget.Size()) / 2f,
				null,
				Color.White,
				0f,
				Vector2.Zero,
			...
			Main.instance.GraphicsDevice.SetRenderTarget(Main.instance.tile2Target);
			Main.instance.GraphicsDevice.Clear(Color.Transparent);
			Main.spriteBatch.Begin();
			Main.spriteBatch.Draw(
				surface,
